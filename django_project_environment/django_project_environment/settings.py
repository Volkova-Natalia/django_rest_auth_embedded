"""
Django settings for django_project_environment project.
...
ROOT_URLCONF = 'django_project_environment.urls'
...
WSGI_APPLICATION = 'django_project_environment.wsgi.application'
